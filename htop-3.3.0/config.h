...
/* Define to 1 if you have the declaration of `IOMainPort', and to 0 if you
   don't. */
/* #undef HAVE_DECL_IOMAINPORT */

/* Define to 1 if you have the declaration of `IOMasterPort', and to 0 if you
   don't. */
/* #undef HAVE_DECL_IOMASTERPORT */
...
#define PACKAGE_STRING "htop 3.3.0"
